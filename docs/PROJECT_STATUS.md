...
- **Two send limits, deliberately.** The Redis limiter is keyed on the address and fails closed; a second count in SQL covers the same address across rotated sessions.
